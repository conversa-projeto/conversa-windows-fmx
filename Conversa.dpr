...
uses
  ...
  Conversa.Notificacao.Tipos in 'src\notificacao\Conversa.Notificacao.Tipos.pas',
  Conversa.Notificacao in 'src\notificacao\Conversa.Notificacao.pas',
  Conversa.Notificacao.Item.Base in 'src\notificacao\Conversa.Notificacao.Item.Base.pas' {NotificacaoItemBase: TFrame},
  Conversa.Notificacao.Item.Mensagem in 'src\notificacao\Conversa.Notificacao.Item.Mensagem.pas' {NotificacaoItemMensagem: TFrame},
  Conversa.Notificacao.Item.Chamada in 'src\notificacao\Conversa.Notificacao.Item.Chamada.pas' {NotificacaoItemChamada: TFrame},
