...
type
  ...
  TRESTMethod = (None, GET, POST, PUT, DELETE, PATCH);
  ...
  public
    ...
    function PATCH: TRESTAPI; overload; virtual;
  end;
...
function TRESTAPI.PATCH: TRESTAPI;
begin
  Result := Method(TRESTMethod.PATCH).InternalExecute;
end;
...
begin
  ...
  try
    case FMethod of
      ...
      TRESTMethod.PATCH : PrepareResponse(Client.Patch(URI, FBody.ToStream, nil, FHeaders.ToHeaders));
    end;
