 // Eduardo - 03/03/2024
unit Conversa.Conversas.Listagem;
...
//    FConteudos: TArray<TConteudo>;
  public
    class function New(AOwner: TFmxObject): TPrincipal;
  end;
...
class function TPrincipal.New(AOwner: TFmxObject): TPrincipal;
begin
  Result := TPrincipal.Create(TComponent(AOwner));
